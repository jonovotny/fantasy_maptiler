(function(){
  ...
  L.Control.LinearMeasurement = L.Control.extend({
      ...
      options: {
          position: 'topleft',
          unitSystem: 'imperial', // imperial | metric | custom
		  unitSystem_custom: {},
		  scaleFactor: 1.0,
          color: '#000000',
      ...
      onAdd: function (map) {
          var container = L.DomUtil.create('div', 'leaflet-control leaflet-bar'),
              link = L.DomUtil.create('a', 'fas fa-ruler', container),
      ...
      resetRuler: function(resetLayer){
          ...
          this.UNIT_CONV = this.options.scaleFactor;
		  ...
		  if(this.options.unitSystem === 'custom'){
              this.UNIT_CONV = this.options.unitSystem_custom.UNIT_CONV * this.options.scaleFactor;
              this.SUB_UNIT_CONV = this.options.unitSystem_custom.SUB_UNIT_CONV;
              this.UNIT = this.options.unitSystem_custom.UNIT;
              this.SUB_UNIT = this.options.unitSystem_custom.SUB_UNIT;
          }
      ...
      displayMarkers: function(latlngs, multi, sum) {
          var x, y, label, ratio, p,
              ...
              original = L.CRS.Simple.distance(prevLatlng,latlng)/this.UNIT_CONV,
              dis = original;
      ...
      getMouseClickHandler: function(e){
          ...
          for(var l in me.latlngsList){
              o = me.latlngsList[l];
              me.sum += L.CRS.Simple.distance(o[0], o[1])/me.UNIT_CONV;
          }
      ...
      getMouseMoveHandler: function(e){
          ...
          if(this.prevLatlng){
              ...
              this.distance = parseFloat(L.CRS.Simple.distance(this.prevLatlng,e.latlng))/this.UNIT_CONV;
